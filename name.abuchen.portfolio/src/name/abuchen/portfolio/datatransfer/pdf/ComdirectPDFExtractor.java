...
public class ComdirectPDFExtractor extends AbstractPDFExtractor
{
    ...
    private void addBuySellTransaction()
    {
        ...
        var firstRelevantLine = new Block("^(?!Steuerliche Behandlung:).*" //
                        + "(Wertpapierkauf" //
                        + "|Wertpapierverkauf" //
                        + "|Wertpapierumtausch" //
        ...
        pdfTransaction //
                        ...
                        .oneOf( //
                                        ...
                                        section -> section //
                                                        .attributes("shares") //
                                                        .match("^[\\s]*St\\.[\\s]{1,}(?<shares>[\\.,\\d]+)[\\s]{1,}[A-Z]{3}[\\s]{1,}[\\.,\\d]+.*$") //
                                        ...
                                        section -> section //
                                                        .attributes("shares") //
                                                        .match("^[\\s]*Summe[\\s]{1,}St\\.[\\s]{1,}(?<shares>[\\.,\\d]+)[\\s]{1,}[A-Z]{3}.*$") //
                                                        .assign((t, v) -> t.setShares(asShares(v.get("shares")))),
                                        // @formatter:off
                                        // St. 16                    iShares PLC-MSCI Wo.UC.ETF DIS A0HGV0
                                        // @formatter:on
                                        ...
                                        section -> section //
                                                        .attributes("shares") //
                                                        .match("^[A-Z]{3}[\\s]{1,}(?<shares>[\\.,\\d]+)[\\s]{1,}[\\.,\\d]+%.*$") //
                                                        .assign((t, v) -> {
                                                            // @formatter:off
                        ...
                        .match("^.*[\\d]{2}\\.[\\d]{2}\\.[\\d]{4} [\\s]{2,}[A-Z]{3}[\\s]{1,}[\\.,\\d]+(?<negative>\\-).*$") //
                        .assign((t, v) -> {
                        ...
                        .oneOf( //
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^zum Kurs von : (?<currencyPerShare>[A-Z]{3})[\\s]{1,}(?<amountPerShare>[\\.,\\d]+).*$") //
                                                        .match("^St\\. (?<shares>[\\.,\\d]+) .* [A-Z0-9]{6}.*$") //
                                                        .match("^wird .ber .* \\( (?<currency>[A-Z]{3}) \\) gebucht\\..*$") //
                                                        .assign((t, v) -> {
                                                            var amountPerShare = Money.of(asCurrencyCode(v.get("currencyPerShare")), asAmount(v.get("amountPerShare")));
                                                            var shares = asBigDecimal(v.get("shares"));

                                                            var amount = Money.of(asCurrencyCode(v.get("currency")), //
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^.*[\\d]{2}\\.[\\d]{2}\\.[\\d]{4}[\\s]{1,}(?<currency>[A-Z]{3})[\\s]{1,}(?<amount>[\\.,\\d]+)[\\s]*$") //
                                                        .assign((t, v) -> {
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^.*Kurswert[\\s]{1,}: (?<termCurrency>[A-Z]{3})[\\s]{1,}(?<fxGross>[\\.,\\d]+).*$") //
                                                        .match("^.*Umrechnung zum Devisenkurs (?<exchangeRate>[\\.,\\d]+)[\\s]{1,}: (?<baseCurrency>[A-Z]{3})[\\s]{1,}[\\.,\\d]+.*$") //
                                                        .find(".*Zu Ihren Lasten.*") //
                                                        .match("^.*[\\d]{2}\\.[\\d]{2}\\.[\\d]{4}[\\s]{1,}[A-Z]{3}[\\s]{1,}[\\.,\\d]+\\-.*$") //
                                                        .assign((t, v) -> {
                                        ...
                                        section -> section //
                                                        .attributes("termCurrency", "fxGross", "exchangeRate", "baseCurrency") //
                                                        .match("^.*Kurswert[\\s]{1,}: (?<termCurrency>[A-Z]{3})[\\s]{1,}(?<fxGross>[\\.,\\d]+).*$") //
                                                        .match("^.*Umrechn\\. zum Dev\\. kurs (?<exchangeRate>[\\.,\\d]+) .*[\\s]{1,}: (?<baseCurrency>[A-Z]{3})[\\s]{1,}[\\.,\\d]+.*$") //
                                                        .find(".*Zu Ihren Lasten.*") //
                                                        .match("^.*[\\d]{2}\\.[\\d]{2}\\.[\\d]{4} [\\s]{2,}[A-Z]{3}[\\s]{1,}[\\.,\\d]+\\-.*$") //
                                                        .assign((t, v) -> {
                                                            var rate = asExchangeRate(v);
                                                            type.getCurrentContext().putType(rate);
                                        ...
                                        section -> section //
                                                        ...
                                                        .assign((t, v) -> {
                                                            var forex = asCurrencyCode(v.get("baseCurrency"));
                        ...
                        .optionalOneOf( //
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^[\\s]*St\\.[\\s]{1,}[\\.,\\d]+[\\s]{1,}(?<termCurrency>[A-Z]{3})[\\s]{1,}[\\.,\\d]+.*$") //
                                                        .match("^.*Umrechn\\. zum Dev\\. kurs (?<exchangeRate>[\\.,\\d]+).*$") //
                                                        .find(".*Zu Ihren (Gunsten|Lasten).*") //
                                                        .match("^.*[\\d]{2}\\.[\\d]{2}\\.[\\d]{4}[\\s]{1,}(?<baseCurrency>[A-Z]{3})[\\s]{1,}(?<gross>[\\.,\\d]+).*$") //
                                                        .assign((t, v) -> {
                                                            if (!type.getCurrentContext().getBoolean("negative"))
                                                            {
                                                                var rate = asExchangeRate(v);
                                        ...
                                        section -> section //
                                                        .attributes("termCurrency", "fxGross", "exchangeRate", "baseCurrency") //
                                                        .match("^[\\s]*Summe[\\s]{1,}St\\.[\\s]{1,}[\\.,\\d]+[\\s]{1,}[A-Z]{3}[\\s]{1,}[\\.,\\d]+[\\s]{1,}(?<termCurrency>[A-Z]{3})[\\s]{1,}(?<fxGross>[\\.,\\d]+).*$") //
                                                        .match("^.*Umrechn\\. zum Dev\\. kurs (?<exchangeRate>[\\.,\\d]+) .*[\\s]{1,}: (?<baseCurrency>[A-Z]{3})[\\s]{1,}[\\.,\\d]+.*$") //
                                                        .assign((t, v) -> {
                                                            if (!type.getCurrentContext().getBoolean("negative"))
                                                            {
    ...
    private void addSellWithNegativeAmountTransaction()
    {
        ...
        var firstRelevantLine = new Block("^(?!Steuerliche Behandlung:).*Wertpapierverkauf.*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        .optionalOneOf( //
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^.*Umrechn\\. zum Dev\\. kurs (?<exchangeRate>[\\.,\\d]+) .*[\\s]{1,}: (?<baseCurrency>[A-Z]{3})[\\s]{1,}[\\.,\\d]+.*$") //
                                                        .find(".*Zu Ihren Lasten.*") //
                                                        .match("^.*[\\d]{2}\\.[\\d]{2}\\.[\\d]{4}[\\s]{1,}(?<currency>[A-Z]{3})[\\s]{1,}(?<amount>[\\.,\\d]+)\\-.*$") //
                                                        .assign((t, v) -> {
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^.*Kurswert [\\s]*:[\\s]{1,}(?<fxCurrency>[A-Z]{3})[\\s]{1,}(?<fxGross>[\\.,\\d]+).*$")
                                                        .find(".*Zu Ihren Lasten.*") //
                                                        .match("^.*[\\d]{2}\\.[\\d]{2}\\.[\\d]{4}[\\s]{1,}(?<currency>[A-Z]{3})[\\s]{1,}(?<amount>[\\.,\\d]+)\\-.*$") //
                                                        .assign((t, v) -> {
    ...
    private void addDividendeTransaction()
    {
        ...
        pdfTransaction //
                        ...
                        .oneOf( //
                                        ...
                                        section -> section //
                                                        .attributes("name", "wkn", "nameContinued", "isin", "currency") //
                                                        .match("^[\\s]*p[\\s]*e[\\s]*r[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<name>.*)[\\s]{1,}(?<wkn>(?:[A-Z0-9][\\s]*){6}).*$") //
                                                        .match("^[\\s]*S[\\s]*T[\\s]*K[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<nameContinued>.*)[\\s]{1,}(?<isin>(?:[A-Z0-9][\\s]*){12}).*$") //
                                                        .match("^(?<currency>[A-Z]{3}) [\\.,\\d]+[\\s]{1,}Dividende pro St.ck .*$") //
                                                        .assign((t, v) -> {
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^[\\s]*p[\\s]*e[\\s]*r[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<name>.*)[\\s]{1,}(?<wkn>(?:[A-Z0-9][\\s]*){6})$") //
                                                        .match("^[\\s]*S[\\s]*T[\\s]*K[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<nameContinued>.*)[\\s]{1,}(?<isin>(?:[A-Z0-9][\\s]*){12})$") //
                                                        .match("^(?<currency>[A-Z]{3}) [\\.,\\d]+[\\s]{1,}Aussch.ttung pro St.ck .*$") //
                                                        .assign((t, v) -> {
                                                            v.put("wkn", stripBlanks(v.get("wkn")));
                                                            v.put("isin", stripBlanks(v.get("isin")));
                                                            v.put("name", trim(replaceMultipleBlanks(v.get("name"))));
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^[\\s]*p[\\s]*e[\\s]*r[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<name>.*)[\\s]{1,}(?<wkn>(?:[A-Z0-9][\\s]*){6})$") //
                                                        .match("^[\\s]*S[\\s]*T[\\s]*K[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<nameContinued>.*)[\\s]{1,}(?<isin>(?:[A-Z0-9][\\s]*){12})$") //
                                                        .match("^(?<currency>[A-Z]{3}) [\\.,\\d]+[\\s]{1,}Thesaurierung pro St.ck.*$") //
                                                        .assign((t, v) -> {
                                                            v.put("wkn", stripBlanks(v.get("wkn")));
                                                            v.put("isin", stripBlanks(v.get("isin")));
                                                            v.put("name", trim(replaceMultipleBlanks(v.get("name"))));
                                        ...
                                        section -> section //
                                                        ...
                                                        .find("Zinsgutschrift.*")
                                                        .match("^[\\s]*p[\\s]*e[\\s]*r[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<name>.*)[\\s]{1,}(?<wkn>(?:[A-Z0-9][\\s]*){6})$") //
                                                        .match("^(?<currency>(?:[A-Z][\\s]*){3})[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}(?<nameContinued>.*)[\\s]{1,}(?<isin>(?:[A-Z0-9][\\s]*){12})$") //
                                                        .assign((t, v) -> {
                                                            v.put("wkn", stripBlanks(v.get("wkn")));
                                                            v.put("isin", stripBlanks(v.get("isin")));
                        ...
                        .match("^[\\s]*(?<notation>(?:[A-Z][\\s]*){3})[\\s]{1,}(?<shares>[\\.,\\d\\s]+).*$") //
                        .assign((t, v) -> {
                        ...
                        .oneOf( //
                                        ...
                                        section -> section //
                                                        .attributes("currency", "amount") //
                                                        .match("^[\\s]*p[\\s]*e[\\s]*r[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}.*[\\s]{1,}(?:[A-Z0-9][\\s]*){6}$") //
                                                        .match("^[\\s]*S[\\s]*T[\\s]*K[\\s]{1,}[\\.,\\d\\s]+[\\s]{1,}.*[\\s]{1,}(?:[A-Z0-9][\\s]*){6}$") //
                                                        .match("^(?<currency>[A-Z]{3}) (?<amount>[\\.,\\d]+)[\\s]{1,}Thesaurierung pro St.ck .*$") //
                                                        .assign((t, v) -> {
                                                            t.setCurrencyCode(asCurrencyCode(v.get("currency")));
                                                            t.setAmount(0L);
                                                        }))
                        ...
                        .optionalOneOf(
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^Bruttobetrag:[\\s]{1,}[A-Z]{3}[\\s]{1,}(?<fxGross>[\\.,\\d]+).*$") //
                        ...
                        .optionalOneOf( //
                                        ...
                                        // @formatter:on
                                        section -> section //
                                                        .attributes("fxCurrency", "fxGross", "baseCurrency", "termCurrency", "exchangeRate", "currencyWithHoldingTax", "withHoldingTax") //
                                                        .match("^Bruttobetrag:[\\s]{1,}(?<fxCurrency>[A-Z]{3})[\\s]{1,}(?<fxGross>[\\.,\\d]+).*$") //
                                                        .match("^.*zum Devisenkurs: (?<baseCurrency>[A-Z]{3})\\/(?<termCurrency>[A-Z]{3})[\\s]{1,}(?<exchangeRate>[\\.,\\d]+) .*$") //
                                                        .match("^.*nicht erstattungsf.hige Quellensteuer .*[\\s]{1,}(?<currencyWithHoldingTax>[A-Z]{3})[\\s]{1,}(?<withHoldingTax>[\\.,\\d]+).*$") //
                                                        .assign((t, v) -> {
                                                            var rate = asExchangeRate(v);
                                                            type.getCurrentContext().putType(rate);

                                                            var fxWithHoldingTax = Money.of(rate.getTermCurrency(), asAmount(v.get("withHoldingTax")));
                                                            var withHoldingTax = rate.convert(rate.getBaseCurrency(), fxWithHoldingTax);
    ...
    private void addTaxesTreatmentTransaction()
    {
        ...
        pdfTransaction //
                        ...
                        .oneOf( //
                                        ...
                                        //
                                        // Z u  Ih r e n G u n s t e n v o r S te u e r n :                                                                                                    E U R             250,0 1
                                        // S  te u e rb e m  e ss u n g s g r u n d la g e ( 1 )                                                     E  U   R                             -   2  7 , 0 1
                                        // a b g e f ü h rt e S t e u er n                                                                                                                    E_ U_ R_ _ _ _ _ _ _ _  _ _ _ _ _ _ _0_,_0_ 0_
                                        // @formatter:on
                                        section -> section //
    ...
    private void addDepositoryFeeTransaction()
    {
        ...
        var firstRelevantLine = new Block("^.*Verwahrentgelt.*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
    ...
    private void addFinancialReport()
    {
        var type = new DocumentType("Finanzreport", (context, lines) -> {
            ...
            var pStartForeignCurrency = Pattern.compile("^W.hrungsanlagekonto \\([A-Z]{3}\\)$");
            var pEndForeignCurrency = Pattern.compile("^Neuer Saldo .*$");

            var foreignCurrencyAccount = false;
            var startInForeignCurrencyIndex = -1;
            var endInForeignCurrencyIndex = -1;
            ...
            for (var i = 0; i < lines.length; i++)
            {
                ...
                switch (line)
                {
                    ...
                    default:
                        ...
                        var mEndForeignCurrency = pEndForeignCurrency.matcher(line);
                        ...
                        var mAccountingBillDate = pAccountingBillDate.matcher(line);
        ...
        var removalBlock = new Block("(^|^A)[\\d]{2}\\.[\\d]{2}\\.[\\d]{4} " //
                        + "(Konto.bertrag" //
                        + "|.bertrag" //
                        + "|Lastschrift" //
                        + "|Visa\\-Umsatz" //
        ...
        removalBlock.set(new Transaction<AccountTransaction>()
                        ...
                        .assign((t, v) -> {
                            ...
                            var hasForeignCurrencyBlock = context.containsKey("startInForeignCurrency")
        ...
        var depositBlock = new Block("(^|^A)[\\d]{2}\\.[\\d]{2}\\.[\\d]{4} " //
                        + "(Konto.bertrag" //
                        + "|.bertrag" //
                        + "|Guthaben.bertr" //
                        + "|Gutschrift" //
        ...
        var accountingBillFeeBlock = new Block("^Versandpauschale [\\.,\\d]+\\- [A-Z]{3}$");
        ...
        // @formatter:on
        var interestBlock = new Block("^[\\d]{2}\\.[\\d]{2}\\.[\\d]{4} Kontoabschluss Abschluss Zinsen.* [\\-|\\+][\\.,\\d]+$");
        ...
        interestBlock.set(new Transaction<AccountTransaction>()
                        ...
                        .section("note").optional()
                        .match("^.*(von|vom) (?<note>[\\d]{2}\\.[\\d]{2}\\.[\\d]{4} bis [\\d]{2}\\.[\\d]{2}\\.[\\d]{4}).*$")
        ...
        // 11.11.2024   ng
        // @formatter:on
        var taxesBlock = new Block("^.*Steuerverrechnu(ng)?.*$");
    ...
    private <T extends Transaction<?>> void addTaxesSectionsTransaction(T transaction, DocumentType type)
    {
        transaction
                        ...
                        .match("^.*Transaktionssteuer[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<tax>[\\.,\\d]+)([\\-\\s]+)?$") //
                        ...
                        // @formatter:on
                        .section("currency", "tax").optional() //
                        .match("^.*nicht erstattungsf.hige Quellensteuer in H.he von[\\s]{1,}(?<currency>[A-Z]{3})[\\s]{1,}(?<tax>[\\.,\\d]+).*$") //
                        .assign((t, v) -> processTaxEntries(t, v, type))
                        ...
                        // @formatter:on
                        .section("currency", "tax").optional() //
                        .match("^.*Kapitalertragsteuer auf[\\s]{1,}[A-Z]{3}[\\s]{1,}[\\.,\\d]+[\\s]{1,}(?<currency>[A-Z]{3})[\\s]{1,}(?<tax>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> processTaxEntries(t, v, type))
                        ...
                        // @formatter:on
                        .section("currency", "tax").optional() //
                        .match("^.*Solidarit.tszuschl\\. auf[\\s]{1,}[A-Z]{3}[\\s]{1,}[\\.,\\d]+[\\s]{1,}(?<currency>[A-Z]{3})[\\s]{1,}(?<tax>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> processTaxEntries(t, v, type));
    }
    ...
    private <T extends Transaction<?>> void addFeesSectionsTransaction(T transaction, DocumentType type)
    {
        transaction
                        ...
                        .match("^fremde Spesen[\\s]{1,}(?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                        ...
                        // @formatter:on
                        .section("currency", "fee").optional() //
                        .match("^.*Maklercourtage[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                                processFeeEntries(t, v, type);
                        })
                        ...
                        // @formatter:on
                        .section("currency", "fee").optional() //
                        .match("^.*Abwickl\\.entgelt Clearstream[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                                processFeeEntries(t, v, type);
                        })
                        ...
                        // @formatter:on
                        .section("currency", "fee").optional() //
                        .match("^.*Variable B.rsenspesen[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                                processFeeEntries(t, v, type);
                        })
                        ...
                        // @formatter:on
                        .section("currency", "fee").optional() //
                        .match("^.*Gesamtprovision[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                                processFeeEntries(t, v, type);
                        })
                        ...
                        // @formatter:on
                        .section("currency", "fee").optional() //
                        .match("^.*B.rsenplatzabh.ng\\. Entgelt[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                                processFeeEntries(t, v, type);
                        })
                        ...
                        // @formatter:on
                        .section("currency", "fee").optional() //
                        .match("^.*Umschreibeentgelt[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                                processFeeEntries(t, v, type);
                        })
                        ...
                        // @formatter:on
                        .section("currency", "fee").optional() //
                        .match("^.*Provision[\\s]{1,}: (?<currency>[A-Z]{3})[\\s]{1,}(?<fee>[\\.,\\d]+)([\\-\\s]+)?$") //
                        .assign((t, v) -> {
                            if (!type.getCurrentContext().getBoolean("negative"))
                                processFeeEntries(t, v, type);
                        });
